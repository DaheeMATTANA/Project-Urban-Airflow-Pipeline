...
"""
## (PROD) Build fct_hourly_weather model DAG

This DAG runs every week to refresh fct_hourly_weather in prod.
    - runs all the upstream models
    - every Monday at 5:30AM UTC.
...
with DAG(
    ...
    max_active_tasks=2,
    concurrency=1,
    tags=["dbt", "fct", "hourly_weather", "prod"],
    doc_md=__doc__,
) as dag:
